...
const enOutcomes = {
  outcomesPage: {
    ...
    exportOutcome: "Export outcome",
    deleteOutcome: "Delete outcome",
    deleteHelp: "Permanently deletes this draft or cancelled Outcome.",
    deleting: "Deleting",
    verifyCriterion: "Review evidence",
    verifyHelp: "Record whether the current evidence satisfies this criterion.",
