...
export const en: TranslationMap & {
  ...
  outcomesPage: {
    ...
    refresh: "Refresh",
    refreshing: "Refreshing outcome",
    refreshFailed: "Could not refresh outcome: {error}",
    cancel: "Cancel",
    cancelOutcome: "Cancel outcome",
    cancelHelp: "This stops tracking the Outcome. You cannot resume it.",
    confirmCancel: "Cancel outcome",
    cancelling: "Cancelling outcome",
    cancelFailed: "Could not cancel outcome: {error}",
