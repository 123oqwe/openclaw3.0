...
const ALLOWED_PATHS = new Set([
  ...
  "extensions/outcomes/src/assurance/attention.test.ts",
  "extensions/outcomes/src/assurance/attention.ts",
  "extensions/outcomes/src/assurance/closure.test.ts",
  "extensions/outcomes/src/assurance/closure.ts",
  ...
  "ui/src/pages/outcomes/outcome-cancel-dialog.ts",
  "ui/src/pages/outcomes/outcome-delete-dialog.ts",
